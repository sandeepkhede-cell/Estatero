# Real Estate App — AI Development Workflow

99acres-style real estate platform built with React + Vite + TypeScript + Tailwind (frontend) and Node.js + Express + PostgreSQL (backend).
